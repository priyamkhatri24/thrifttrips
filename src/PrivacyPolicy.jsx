...
const PrivacyPolicy = () => {
  useEffect(() => {
          ...
          <strong>
             <span style="font-size: 15px;">
                <span data-custom-class="subtitle">
                   Last updated 
                   <bdt class="question">January 15, 2024</bdt>
                </span>
             </span>
          </strong>
       </span>
       ...
       <span style="color: rgb(127, 127, 127);">
          <span style="color: rgb(89, 89, 89); font-size: 15px;">
             <span data-custom-class="body_text">
                ...
                <bdt class="question">
                   Thrift Trips Pvt ltd.
                   <bdt class="block-component"></bdt>
                   (doing business as 
                   <bdt class="question">Thrift Trips</bdt>
                   )
                   <bdt class="statement-end-if-in-editor"></bdt>
                </bdt>
                (
             ...
             <span style="font-size: 15px; color: rgb(89, 89, 89);">
                <span data-custom-class="body_text">
                   ...
                   <span style="color: rgb(0, 58, 250);">
                      <bdt class="question"><a href="http://www.thrifttrips.in" target="_blank" data-custom-class="link">http://www.thrifttrips.in</a></bdt>
                   </span>
                   <span style="font-size: 15px;">
                      <span style="color: rgb(89, 89, 89);">
                         <span data-custom-class="body_text">
       ...
       <span style="font-size: 15px;">
          <span style="color: rgb(127, 127, 127);">
             <span data-custom-class="body_text">
                ...
                <bdt class="question">thethrifttrips@gmail.com</bdt>
                .
             </span>
          </span>
       </span>
    ...
    <div style="line-height: 1.5;">
       ...
       <a data-custom-class="link" href="https://app.termly.io/notify/520da792-6d5f-435d-bf54-8d4ad1b6f96e" rel="noopener noreferrer" target="_blank"><span style="color: rgb(0, 58, 250); font-size: 15px;"><span data-custom-class="body_text">data subject access request</span></span></a>
       <span style="font-size: 15px;">
          <span data-custom-class="body_text">
             <bdt class="block-component"></bdt>
